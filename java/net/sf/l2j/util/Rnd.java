...
public class Rnd
{
	...
	{
		return (int) (MTRandom.getInstance().getSecureRandom().nextDouble()
		        * n);
	}
	...
	{
		return min
		        + (int) Math.floor(MTRandom.getInstance().getSecureRandom().nextDouble()
		                * (max - min + 1));
	}

	public static final int nextInt(int n)
	{
		return (int) Math.floor(MTRandom.getInstance().getSecureRandom().nextDouble()
		        * n);
	}
