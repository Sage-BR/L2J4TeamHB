...
{
	private static final int[] ITEM_IDS = { 3926, 3927, 3928, 3929, 3930, 3931,
	        3932, 3933, 3934, 3935, 4218, 5593, 5594, 5595, 6037, 5703, 5803,
	        5804, 5805, 5806, 5807, // lucky charm
	        ...
	        9146, 9147, 9148, 9149, 9150, 9151, 9152, 9153, 9154, 9155, 9897,
	        10131, 10132, 10133, 10134, 10135, 10136, 10137, 10138, 10151, 10274 // transformation
	                                                                             // scrolls
	};
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		if (itemId >= 8594 && itemId <= 8599) // Scrolls of recovery XML: 2286
		{
			...
			if ((itemId == 8594 && expIndex == 0) || // Scroll: Recovery (No
			                                         // Grade)
			        (itemId == 8595 && expIndex == 1) || // Scroll: Recovery (D
			                                             // Grade)
			        (itemId == 8596 && expIndex == 2) || // Scroll: Recovery (C
			                                             // Grade)
			        (itemId == 8597 && expIndex == 3) || // Scroll: Recovery (B
			                                             // Grade)
			        (itemId == 8598 && expIndex == 4) || // Scroll: Recovery (A
			                                             // Grade)
			        (itemId == 8599 && (expIndex == 5 || expIndex == 6))) // Scroll:
			                                                              // Recovery
			                                                              // (S/80
			                                                              // Grade)
			{
		...
		else if (itemId == 5703 || itemId >= 5803 && itemId <= 5807)
		{
			...
			if ((itemId == 5703 && expIndex == 0) || // Lucky Charm (No Grade)
			        (itemId == 5803 && expIndex == 1) || // Lucky Charm (D
			                                             // Grade)
			        (itemId == 5804 && expIndex == 2) || // Lucky Charm (C
			                                             // Grade)
			        (itemId == 5805 && expIndex == 3) || // Lucky Charm (B
			                                             // Grade)
			        (itemId == 5806 && expIndex == 4) || // Lucky Charm (A
			                                             // Grade)
			        (itemId == 5807 && (expIndex == 5 || expIndex == 6))) // Lucky
			                                                              // Charm
			                                                              // (S/80
			                                                              // Grade)
			{
				...
				activeChar.broadcastPacket(new MagicSkillUse(playable, playable, 2168, (expIndex > 5 ? expIndex : expIndex
				        + 1), 1, 0));
				useScroll(activeChar, 2168, (expIndex > 5 ? expIndex : expIndex
				        + 1));
		...
		else if (itemId >= 8515 && itemId <= 8520) // Charm of Courage XML: 5041
		{
			...
			if ((itemId == 8515 && expIndex == 0) || // Charm of Courage (No
			                                         // Grade)
			        (itemId == 8516 && expIndex <= 1) || // Charm of Courage (D
			                                             // Grade)
			        (itemId == 8517 && expIndex <= 2) || // Charm of Courage (C
			                                             // Grade)
			        (itemId == 8518 && expIndex <= 3) || // Charm of Courage (B
			                                             // Grade)
			        (itemId == 8519 && expIndex <= 4) || // Charm of Courage (A
			                                             // Grade)
			        (itemId == 8520 && expIndex <= 6)) // Charm of Courage (S/80
			                                           // Grade)
			{
				if (!playable.destroyItem("Consume", item.getObjectId(), 1, null, false))
				{
		...
		else if (itemId == 9897 || itemId >= 10131 && itemId <= 10138
		        || itemId == 10151 || itemId == 10274) // transformation scrolls
		{
