...
public class SummonItems implements IItemHandler
{
	...
	{
		if (!(playable instanceof L2PcInstance) || !TvTEvent.onItemSummon(playable.getObjectId()))
		{
			return;
		}
		...
		switch (sitem.getType())
		{
			case 0: // static summons (like Christmas tree)
				try
				{
					...
					activeChar.sendMessage("Created " + npcTemplate.name
					        + " at x: " + spawn.getLocx() + " y: "
			...
			case 1: // pet summons
				...
				petSummon.spawnMe(activeChar.getX() + 50, activeChar.getY()
				        + 100, activeChar.getZ());
