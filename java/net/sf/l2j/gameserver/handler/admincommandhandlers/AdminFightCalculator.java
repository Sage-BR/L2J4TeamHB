...
public class AdminFightCalculator implements IAdminCommandHandler
{
	...
	private static final String[] ADMIN_COMMANDS = { "admin_fight_calculator",
	        "admin_fight_calculator_show", "admin_fcs", };
	...
	private void handleStart(String params, L2PcInstance activeChar)
	{
		...
		if (npc1 != null && npc2 != null)
		{
			...
			replyMSG.append("<button value=\"OK\" action=\"bypass -h admin_fight_calculator_show "
		...
		else if (lvl1 != 0 && npc1 == null)
		{
			...
			{
				replyMSG.append("<tr><td><a action=\"bypass -h admin_fight_calculator lvl1 "
				        + lvl1 + " lvl2 " + lvl2 + " mid1 " + n.npcId + " mid2 "
				        + mid2 + "\">" + n.name + "</a></td></tr>");
			}
		...
		else if (lvl2 != 0 && npc2 == null)
		{
			...
			{
				replyMSG.append("<tr><td><a action=\"bypass -h admin_fight_calculator lvl1 "
				        + lvl1 + " lvl2 " + lvl2 + " mid1 " + mid1 + " mid2 "
				        + n.npcId + "\">" + n.name + "</a></td></tr>");
			}
			replyMSG.append("</table></body></html>");
		}
		else
