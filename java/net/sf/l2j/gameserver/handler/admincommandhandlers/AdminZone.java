...
{
	private static final String[] ADMIN_COMMANDS = { "admin_zone_check",
	        "admin_zone_reload" };
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		if (actualCommand.equalsIgnoreCase("admin_zone_check"))
		{
			...
			activeChar.sendMessage("MapRegion: x:"
			        + MapRegionTable.getInstance().getMapRegionX(activeChar.getX())
			        + " y:"
			        + MapRegionTable.getInstance().getMapRegionX(activeChar.getY()));

			activeChar.sendMessage("Closest Town: "
