...
public class AdminDoorControl implements IAdminCommandHandler
{
	...
	private static final String[] ADMIN_COMMANDS = { "admin_open",
	        "admin_close", "admin_openall", "admin_closeall" };
	// private static final Map<String, Integer> doorMap = new
	// ConcurrentHashMap<String, Integer>(); //FIXME: should we jute remove
	// this?
