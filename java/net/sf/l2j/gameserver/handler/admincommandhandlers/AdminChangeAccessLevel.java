...
/**
 * This class handles following admin commands: - changelvl = change a
 * character's access level Can be used for character ban (as opposed to regular
 * //ban that affects accounts) or to grant mod/GM privileges ingame
 *
...
public class AdminChangeAccessLevel implements IAdminCommandHandler
{
		...
		else if (parts.length == 3)
		{
			...
			else
			{
				...
				try
				{
					...
					{
						activeChar.sendMessage("Character's access level is now set to "
						        + lvl);
					}
				}
	 ...
	 * @param lvl
	 */
	private void onLineChange(L2PcInstance activeChar, L2PcInstance player,
	        int lvl)
	{
