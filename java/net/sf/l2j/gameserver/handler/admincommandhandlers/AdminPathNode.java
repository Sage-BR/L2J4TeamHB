...
{
	private static final String[] ADMIN_COMMANDS = { "admin_pn_info",
	        "admin_show_path", "admin_path_debug", "admin_show_pn",
	        "admin_find_path", };
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.equals("admin_find_path"))
		{
			...
			if (activeChar.getTarget() != null)
			{
				...
				int gtx = (activeChar.getTarget().getX()
				        - L2World.MAP_MIN_X) >> 4;
				int gty = (activeChar.getTarget().getY()
				        - L2World.MAP_MIN_Y) >> 4;
				...
				{
					activeChar.sendMessage("x:" + a.getX() + " y:" + a.getY()
					        + " z:" + a.getZ());
				}
			}
			else
