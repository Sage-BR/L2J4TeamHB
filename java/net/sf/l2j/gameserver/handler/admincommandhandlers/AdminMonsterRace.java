...
public class AdminMonsterRace implements IAdminCommandHandler
{
	...
	{
		/*
		 * -1 0 to initialize the race 0 15322 to start race 13765 -1 in middle
		 * of race -1 0 to end the race
		 *
		 * 8003 to 8027
		 */
	...
	class RunRace implements Runnable
	{
		...
		public void run()
		{
			 ...
			 * j<20; j++) { //_log.info("Adding "+speeds1[i][j] +" and "+
			 * speeds2[i][j]); speed[i] += (speeds1[i][j]*1);// +
			 * (speeds2[i][j]*1); }
