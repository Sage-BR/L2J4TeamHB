...
public class AdminShutdown implements IAdminCommandHandler
{
	...
	private static final String[] ADMIN_COMMANDS = { "admin_server_shutdown",
	        "admin_server_restart", "admin_server_abort" };
	...
	private void sendHtmlForm(L2PcInstance activeChar)
	{
		...
		adminReply.replace("%used%", String.valueOf(Runtime.getRuntime().totalMemory()
