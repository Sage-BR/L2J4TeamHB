...
{
	private static final String[] ADMIN_COMMANDS = { "admin_ride_wyvern",
	        "admin_ride_strider", "admin_unride_wyvern", "admin_unride_strider",
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		if (command.startsWith("admin_ride"))
		{
			...
			{
				activeChar.sendMessage("Command '" + command
				        + "' not recognized");
				return false;
			}
