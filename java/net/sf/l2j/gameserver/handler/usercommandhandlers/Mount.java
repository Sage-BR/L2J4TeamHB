...
public class Mount implements IUserCommandHandler
{
	...
	public synchronized boolean useUserCommand(int id, L2PcInstance activeChar)
	{
		...
		if (pet != null && pet.isMountable() && pet.isMountableOverTime()
		        && !activeChar.isMounted())
		{
			...
			/**
			 * TODO: Add Siege Flag Restriction, else if
			 * (activeChar.isFlagEquipped()) { // You cannot mount a steed while
			 * holding a flag. SystemMessage msg = new
			 * SystemMessage(SystemMessageId.YOU_CANNOT_MOUNT_A_STEED_WHILE_HOLDING_A_FLAG);
			 * activeChar.sendPacket(msg); }
			 */
