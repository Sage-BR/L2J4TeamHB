...
public class Wedding implements IVoicedCommandHandler
{
	...
	private static String[] _voicedCommands = { "divorce", "engage",
	        "gotolove" };
	...
	public boolean divorce(L2PcInstance activeChar)
	{
		...
		if (activeChar.isMarried())
		{
			...
			AdenaAmount = (activeChar.getAdena() / 100)
			        * Config.L2JMOD_WEDDING_DIVORCE_COSTS;
	...
	public boolean engage(L2PcInstance activeChar)
	{
		...
		// $s1
		ConfirmDlg dlg = new ConfirmDlg(SystemMessageId.S1.getId()).addString(activeChar.getName()
	...
	public boolean goToLove(L2PcInstance activeChar)
	{
		...
		if (activeChar.getPartnerId() == 0)
		{
			...
			_log.severe("Married but couldn't find parter for "
			        + activeChar.getName());
			return false;
		}
		...
		else if (partner.isInParty()
		        && partner.getParty().isInDimensionalRift())
		{
		...
		else if (activeChar.isFestivalParticipant())
		{
			...
			return false;
		        ...
		        && activeChar.getParty().isInDimensionalRift())
		{
		...
		activeChar.sendMessage("After " + teleportTimer / 60000
		        + " min. you will be teleported to your fiance.");
		...
		activeChar.setSkillCastEndTime(10 + GameTimeController.getGameTicks()
		        + teleportTimer / GameTimeController.MILLIS_IN_TICK);
