...
public class Pdam implements ISkillHandler
{
	        ...
	        L2Object[] targets)
	{
		...
		for (L2Object target2 : targets)
		{
			...
			{
				crit = f.calcCrit(skill.getBaseCritRate() * 10
				        * f.getSTRBonus(activeChar));
			}
			                                                  ...
			                                                  // Raging Force
			{
				...
				else
				{
					...
					{
						L2Skill dummy = SkillTable.getInstance().getInfo(8, 8); // Lv7
						                                                        // Sonic
						                                                        // Focus
					...
					{
						L2Skill dummy = SkillTable.getInstance().getInfo(50, 8); // Lv7
						                                                         // Focused
						                                                         // Force
						dummy.getEffects(activeChar, activeChar);
					}
