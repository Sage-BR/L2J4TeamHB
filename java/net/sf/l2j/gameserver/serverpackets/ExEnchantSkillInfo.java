...
public final class ExEnchantSkillInfo extends L2GameServerPacket
{
	...
	static class SkillEnchantDetailElement
	{
		...
		public SkillEnchantDetailElement(int level, int rate, int spCost,
		        int expCost)
		{
			_level = level;
			_rate = rate;
		...
		public SkillEnchantDetailElement(L2PcInstance cha,
	...
	public void addEnchantSkillDetail(int level, int rate, int spCost,
	        int expCost)
	{
