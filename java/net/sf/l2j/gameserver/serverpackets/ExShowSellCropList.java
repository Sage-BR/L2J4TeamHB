 ...
 *
 * d - manor id d - size [ d - Object id d - crop id d - seed level c d - reward
 * 1 id c d - reward 2 id d - manor d - buy residual d - buy price d - reward ]
 *
 * @author l3x
 */
...
public class ExShowSellCropList extends L2GameServerPacket
{
	...
	{
		_manorId = manorId;
		_castleCrops = new ConcurrentHashMap<>();
		_cropsItems = new ConcurrentHashMap<>();
