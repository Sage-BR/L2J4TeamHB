	...
	protected final void writeImpl()
	{
		...
		if (_clan != null)
		{
			...
			writeD(_clan.getHasHideout() > 0 ? 0x01 : 0x00); // 6d 01 00 00 00 -
			                                                 // to hide away
			writeD(_clan.getHasCastle() > 0 || isInCastleDefense ? 0x01 : 0x00); // 6d
			                                                                     // 02
			                                                                     // 00
			                                                                     // 00
			                                                                     // 00
			                                                                     ...
			                                                                     // to
			                                                                     // castle
			writeD(siegeClan != null && !isInCastleDefense && !isInFortDefense
			...
			writeD(_access.allowFixedRes() ? 0x01 : 0x00); // 6d 04 00 00 00 -
			                                               // to FIXED
			writeD(_clan.getHasFort() > 0 || isInFortDefense ? 0x01 : 0x00); // 6d
			                                                                 // 05
			                                                                 // 00
			                                                                 // 00
			                                                                 // 00
