...
public class CharSelectionInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		// Can prevent players from creating new characters (if 0); (if 1, the
		// client will ask if chars may be created (0x13) Response: (0x0D) )
		writeD(0x07);
		writeC(0x00);
		...
		for (int i = 0; i < size; i++)
		{
			...
			// writeD(charInfoPackage.getTransformId()); // Used to display
			// Transformations
			writeD(0x00); // Currently on retail when you are on character
			              // select you don't see your transformation.
		}
	}
