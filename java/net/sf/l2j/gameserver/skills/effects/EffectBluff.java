...
final class EffectBluff extends L2Effect
{
	...
	public void onStart()
	{
		...
		if ((getEffected() instanceof L2FolkInstance) || getEffected() instanceof L2NpcInstance
		...
		getEffected().getAI().setIntention(CtrlIntention.AI_INTENTION_MOVE_TO, new L2CharPosition(posX
		        + (signx * 40), posY + (signy * 40), posZ, 0));
