...
public class L2SkillDrain extends L2Skill
{
	...
	public void useSkill(L2Character activeChar, L2Object[] targets)
	{
		...
		for (L2Object target2 : targets)
		{
			...
			if ((target.isAlikeDead()
			        && getTargetType() != SkillTargetType.TARGET_CORPSE_MOB) || (activeChar != target && target.isInvul()))
			{
	...
	public void useCubicSkill(L2CubicInstance activeCubic, L2Object[] targets)
	{
		...
		for (L2Object target2 : targets)
		{
			...
			if (Config.DEBUG)
			{
				_log.info("L2SkillDrain: useCubicSkill() -> damage = "
				        + damage);
			}
			...
			double hp = ((owner.getCurrentHp()
			        + hpAdd) > owner.getMaxHp() ? owner.getMaxHp() : (owner.getCurrentHp()
			                + hpAdd));
