...
public class AiManager
{
	...
	public void load()
	{
		try
		{
			// TODO redo all the SpecificAiManger loading it's completely messed
			// up:
			...
			for (String file : directory.list())
			{
				if (file.endsWith(".class"))
				{
					try
					{
						Class<?> managerClass = Class.forName("net.sf.l2j.gameserver.ai.managers."
						...
						for (EventHandler handler : managerInstance.getEventHandlers())
						{
							...
							// let's check if any previously created AiInstance
							// is allready used for the NPC concerned by this
							// handler
	...
	public String getParameter(String who, String paramsType, String param1,
	        String param2)
	{
