 ...
 *
 * $Author: luisantonioa $ $Date: 24/08/2005 22:32:43 $ $Revision: 1 $ $Log:
 * CompactionIDFactory.java,v $ Revision 1 24/08/2005 22:32:43 luisantonioa
		...
		if (Config.BAD_ID_CHECKING)
		{
			for (String check : ID_CHECKS)
			{
				...
				while (rs.next())
				{
					...
					_log.severe("Bad ID " + badId + " in DB found by: "
					        + check);
