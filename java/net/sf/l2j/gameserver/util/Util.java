 ...
 *
 * $Author: luisantonioa $ $Date: 21/10/2005 23:17:40 $ $Revision: 1 $ $Log:
 * Util.java,v $ Revision 1 21/10/2005 23:17:40 luisantonioa Added copyright
 * notice
 *
 *
...
public final class Util
{
	 ...
	 * being the origin
	 */
	public final static double calculateAngleFrom(int obj1X, int obj1Y,
	        int obj2X, int obj2Y)
	{
	...
	/*
	 * Checks if object is within short (sqrt(int.max_value)) radius, not using
	 * collisionRadius. Faster calculation than checkIfInRange if distance is
	 * short and collisionRadius isn't needed. Not for long distance checks
	 * (potential teleports, far away castles etc)
	 */
	public static boolean checkIfInShortRadius(int radius, L2Object obj1,
	        L2Object obj2, boolean includeZAxis)
	{
		if (obj1 == null || obj2 == null)
		{
