...
public class RaidBossSpawnManager
{
	...
	private void init()
	{
		...
		_schedules = new ConcurrentHashMap<>();
		...
		try
		{
			...
			while (rset.next())
			{
				...
				{
					_log.warning("RaidBossSpawnManager: Could not load raidboss #"
	...
	private class spawnSchedule implements Runnable
	{
		...
		public void run()
		{
			...
			if (raidboss != null)
			{
				...
				{
					Broadcast.gameAnnounceToOnlinePlayers("Boss: "
					        + raidboss.getName()
					        + " has spawned in the world!");
				}
			}
	...
	public void updateStatus(L2RaidBossInstance boss, boolean isBossDead)
	{
		...
		if (isBossDead)
		{
			...
			long respawn_delay = Rnd.get((int) (RespawnMinDelay * 1000
			        * Config.RAID_MIN_RESPAWN_MULTIPLIER), (int) (RespawnMaxDelay
			                * 1000 * Config.RAID_MAX_RESPAWN_MULTIPLIER));
	...
	public void notifySpawnNightBoss(L2RaidBossInstance raidboss)
	{
		...
		GmListTable.broadcastMessageToGMs("Spawning Raid Boss "
		        + raidboss.getName());
