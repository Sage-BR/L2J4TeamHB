...
public class CastleManager
{
	...
	// =========================================================
	// Constructor
	private static final int _castleCirclets[] = { 0, 6838, 6835, 6839, 6837,
	        6840, 6834, 6836, 8182, 8183 };
	...
	public void removeCirclet(L2ClanMember member, int castleId)
	{
		...
		if (circletId != 0)
		{
			...
			{
				_log.warning("Failed to remove castle circlets offline for player "
				        + member.getName());
				e.printStackTrace();
			}
			finally
