...
public class DayNightSpawnManager
{
	...
	/*
	 * Manage Spawn/Respawn Arg 1 : Map with L2NpcInstance must be unspawned Arg
	 * 2 : Map with L2NpcInstance must be spawned Arg 3 : String for log info
	 * for unspawned L2NpcInstance Arg 4 : String for log info for spawned
	 * L2NpcInstance
	 */
	private void spawnCreatures(Map<L2Spawn, L2NpcInstance> UnSpawnCreatures,
	        Map<L2Spawn, L2NpcInstance> SpawnCreatures, String UnspawnLogInfo,
	        String SpawnLogInfo)
	{
		try
		{
			...
			for (L2Spawn spawnDat : new ArrayList<>(SpawnCreatures.keySet()))
			{
			...
			if (Config.DEBUG)
			{
				_log.info("DayNightSpawnManager: Spawning " + i + " "
				        + SpawnLogInfo + " creatures");
			}
		}
		catch (Exception e)
		{
