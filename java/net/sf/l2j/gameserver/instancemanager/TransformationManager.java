...
public class TransformationManager
{
	...
	{
		_transformations = new ConcurrentHashMap<>();
	}

	public void report()
	{
		_log.info("Loaded: " + this.getAllTransformations().size()
		        + " transformations.");
	}
	...
	public L2Transformation registerTransformation(
	        L2Transformation transformation)
	{
