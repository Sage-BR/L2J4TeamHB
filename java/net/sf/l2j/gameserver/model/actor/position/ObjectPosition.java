...
public class ObjectPosition
{
	...
	{
		if (_worldRegion != null && getActiveObject() instanceof L2Character) // confirm
		                                                                      // revalidation
		                                                                      // of
		                                                                      // old
		                                                                      // region's
		                                                                      // zones
		{
			if (value != null)
			{
				_worldRegion.revalidateZones((L2Character) getActiveObject()); // at
				                                                               // world
				                                                               // region
				                                                               // change
			}
			...
			{
				_worldRegion.removeFromZones((L2Character) getActiveObject()); // at
				                                                               // world
				                                                               // region
				                                                               // change
			}
