...
public class CharStatus
{
	...
	public void reduceHp(double value, L2Character attacker, boolean awake)
	{
		...
		else
		{
			if (attacker instanceof L2PcInstance
			        ...
			        && !(getActiveChar() instanceof L2SummonInstance
			                && ((L2SummonInstance) getActiveChar()).getOwner().getDuelId() == ((L2PcInstance) attacker).getDuelId())) // Duelling
			                                                                                                                          // player
			                                                                                                                          // attacks
			                                                                                                                          // mob
			{
		...
		if (value > 0) // Reduce Hp if any
		{
			...
			if (value <= 0)
			{
				// is the dieing one a duelist? if so change his duel state to
				// dead
				if (getActiveChar() instanceof L2PcInstance
