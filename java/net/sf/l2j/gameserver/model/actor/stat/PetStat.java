...
public class PetStat extends SummonStat
{
	...
	public final long getExpForLevel(int level)
	{
		...
		{
			_log.warning("Pet NPC ID " + getActiveChar().getNpcId() + ", level "
			        + level + " is missing data from pets_stats table!");
			return 5000000L * level; // temp value calculated from lvl 81
			                         // wyvern, 395734658
		}
	}
