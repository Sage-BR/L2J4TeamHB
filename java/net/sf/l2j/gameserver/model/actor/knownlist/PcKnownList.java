...
public class PcKnownList extends PlayableKnownList
{
	...
	public boolean addKnownObject(L2Object object, L2Character dropper)
	{
		...
		else
		{
			...
			else if (object instanceof L2NpcInstance)
			{
				...
				{
					getActiveChar().sendMessage("Added NPC: "
					        + object.getName());
				}
			...
			else if (object instanceof L2Summon)
			{
				...
				if (getActiveChar().equals(summon.getOwner()))
				{
					...
					// The PetInfo packet wipes the PartySpelled (list of active
					// spells' icons). Re-add them
			...
			else if (object instanceof L2PcInstance)
			{
				...
				if (otherPlayer.isInBoat())
				{
					...
					if (otherPlayer.getKnownList().getKnownRelations().get(getActiveChar().getObjectId()) != null
					        && otherPlayer.getKnownList().getKnownRelations().get(getActiveChar().getObjectId()) != relation)
					{
			...
			if (object instanceof L2Character || object instanceof L2Decoy
			        || object instanceof L2DecoyInstance
			        || object instanceof L2Trap
			        || object instanceof L2TrapInstance)
			{
	...
	public boolean removeKnownObject(L2Object object)
	{
		...
		if (Config.CHECK_KNOWN && object instanceof L2NpcInstance npc)
		{
			getActiveChar().sendMessage("Removed NPC: " + npc.getName());
		}
		return true;
	}
