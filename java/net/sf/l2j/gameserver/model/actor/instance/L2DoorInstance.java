...
//            player.sendPacket(my);
	...
	public void onActionShift(L2GameClient client)
	{
		...
		if (player.getAccessLevel().isGm())
		{
			...
			html1.append("<tr><td>Current HP  " + getCurrentHp()
			        + "</td></tr>");
			...
			html1.append("<td><button value=\"Open\" action=\"bypass -h admin_open "
			        + getDoorId()
			        + "\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
			html1.append("<td><button value=\"Close\" action=\"bypass -h admin_close "
			        + getDoorId()
			        + "\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
