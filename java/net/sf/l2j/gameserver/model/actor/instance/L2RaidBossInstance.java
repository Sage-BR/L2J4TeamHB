...
public class L2RaidBossInstance extends L2MonsterInstance
{
	...
	public boolean doDie(L2Character killer)
	{
		...
		if (player != null)
		{
			...
			if (player.getParty() != null)
			{
				...
				{
					RaidBossPointsManager.addPoints(member, this.getNpcId(), (this.getLevel()
					        / 2) + Rnd.get(-5, 5));
			...
			{
				RaidBossPointsManager.addPoints(player, this.getNpcId(), (this.getLevel()
				        / 2) + Rnd.get(-5, 5));
	...
	protected void checkAndReturnToSpawn()
	{
		...
		if (isDead() || isMovementDisabled() || (getNpcId() == 29095))
		{
			return;
		}
