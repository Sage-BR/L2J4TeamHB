		...
		else if (command.startsWith("Festival"))
		{
			...
			switch (val)
			{
				case 1: // Become a Participant
					...
					/*
					 * Check to see if the player has already signed up, if they
					 * are then update the participant list providing all the
				...
				// participants for this festival.
					...
					// Check if the player collected any blood offerings during
					// the festival.
				...
				case 4: // Current High Scores
					...
					strBuffer.append(SevenSignsFestival.getFestivalName(_festivalType)
					        + " festival.<br>");

					if (dawnScore > 0)
					{
						strBuffer.append("Dawn: "
					...
					strBuffer.append("<a action=\"bypass -h npc_"
					        + getObjectId()
