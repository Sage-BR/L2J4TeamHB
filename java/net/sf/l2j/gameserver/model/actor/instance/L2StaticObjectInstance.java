/*
 * $Header: /cvsroot/l2j/L2_Gameserver/java/net/sf/l2j/gameserver/model/
 * L2StaticObjectInstance.java,v 1.3.2.2.2.2 2005/02/04 13:05:27 maximas Exp $
 *
 *
		...
		else
		{
			...
			else
			{
				if (_type == 2)
				{
					...
					if (content == null)
					{
						html.setHtml("<html><body>Signboard is missing:<br>"
						        + filename + "</body></html>");
					}
					else
					{
