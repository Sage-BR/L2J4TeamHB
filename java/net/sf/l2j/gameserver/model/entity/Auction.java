...
public class Auction
{
	...
	private void saveAuctionDate()
	{
		...
		{
			_log.log(Level.SEVERE, "Exception: saveAuctionDate(): "
			        + e.getMessage(), e);
		}
		finally
		{
	...
	private void updateInDB(L2PcInstance bidder, int bid)
	{
		...
		{
			_log.log(Level.SEVERE, "Exception: Auction.updateInDB(L2PcInstance bidder, int bid): "
			        + e.getMessage());
			e.printStackTrace();
		}
		finally
	...
	private void removeBids()
	{
		...
		{
			_log.log(Level.SEVERE, "Exception: Auction.deleteFromDB(): "
			        + e.getMessage(), e);
		}
		finally
		{
	...
	public void endAuction()
	{
		        ...
		        && GameServer.gameServer.getCHManager().loaded())
		{
			...
			{
				/**
				 * If seller haven't sell ClanHall, auction removed, THIS MUST
				 * BE CONFIRMED
				 */
	...
	public void cancelBid(int bidder)
	{
		...
		{
			_log.log(Level.SEVERE, "Exception: Auction.cancelBid(String bidder): "
			        + e.getMessage(), e);
		}
		finally
		{
	...
	public void confirmAuction()
	{
		...
		{
			_log.log(Level.SEVERE, "Exception: Auction.load(): "
			        + e.getMessage(), e);
		}
		finally
		{
