...
public class TvTEvent
{
	...
	public static boolean startParticipation()
	{
		...
		{
			_log.warning("TvTEventEngine[TvTEvent.startParticipation()]: exception: "
			        + e);
			return false;
		}
	...
	public static String calculateRewards()
	{
		...
		return "TvT Event: Event finish. Team " + team.getName() + " won with "
		        + team.getPoints() + " kills.";
	}
	 ...
	 * @return boolean: true if success, otherwise false<br>
	 */
	public static synchronized boolean addParticipant(
	        ...
	        L2PcInstance playerInstance)
	{
		...
		if (command.equals("tvt_event_participation"))
		{
			...
			else if (playerLevel < Config.TVT_EVENT_MIN_LVL
			        || playerLevel > Config.TVT_EVENT_MAX_LVL)
			{
				npcHtmlMessage.setHtml("<html><head><title>TvT Event</title></head><body>Only players from level "
				        + Config.TVT_EVENT_MIN_LVL + " to level "
				        + Config.TVT_EVENT_MAX_LVL
			...
			{
				npcHtmlMessage.setHtml("<html><head><title>TvT Event</title></head><body>The event is full! Only "
				        + Config.TVT_EVENT_MAX_PLAYERS_IN_TEAMS
				        + " players are allowed per team.</body></html>");
			}
	 ...
	 */
	public static boolean onAction(L2PcInstance playerInstance,
	        int targetedPlayerObjectId)
	{
	 ...
	 * @param playerName
	 *            as String<br>
	 * @return boolean: true if player is allowed to use scroll, otherwise
	 *         false<br>
	 */
	public static boolean onScrollUse(int playerObjectId)
	{
		...
		if (isPlayerParticipant(playerObjectId)
		        && !Config.TVT_EVENT_SCROLL_ALLOWED)
		{
			return false;
		}
	 ...
	 * @param playerName
	 *            as String<br>
	 * @return boolean: true if player is allowed to use potions, otherwise
	 *         false<br>
	 */
	public static boolean onPotionUse(int playerObjectId)
	{
		...
		if (isPlayerParticipant(playerObjectId)
		        && !Config.TVT_EVENT_POTIONS_ALLOWED)
		{
			return false;
		}
	 ...
	 * @param playerName
	 *            as String<br>
	 * @return boolean: true if player is allowed to summon by item, otherwise
	 *         false<br>
	 */
	public static boolean onItemSummon(int playerObjectId)
	{
		...
		if (isPlayerParticipant(playerObjectId)
		        && !Config.TVT_EVENT_SUMMON_BY_ITEM_ALLOWED)
		{
			return false;
		}
	 ...
	 *            as L2PcInstance<br>
	 */
	public static void onKill(L2Character killerCharacter,
	        L2PcInstance killedPlayerInstance)
	{
		...
		if (killerTeamId != -1 && killedTeamId != -1
		        && killerTeamId != killedTeamId)
		{
			TvTEventTeam killerTeam = _teams[killerTeamId];

			killerTeam.increasePoints();

			CreatureSay cs = new CreatureSay(killerPlayerInstance.getObjectId(), Say2.TELL, killerPlayerInstance.getName(), "I have killed "
			        + killedPlayerInstance.getName() + "!");
	 ...
	 * <br>
	 *
	 * @return boolean: true if event is inactive(waiting for next event cycle),
	 *         otherwise false<br>
	 */
	 ...
	 * <br>
	 *
	 * @return boolean: true if event is in inactivating progress, otherwise
	 *         false<br>
	 */
	 ...
	 * <br>
	 *
	 * @return boolean: true if event is in participation progress, otherwise
	 *         false<br>
	 */
	 ...
	 * <br>
	 *
	 * @return boolean: true if event is starting up(setting up fighting spot,
	 *         teleport players etc.), otherwise false<br>
	 */
	 ...
	 * <br>
	 *
	 * @return boolean: true if event is currently rewarding, otherwise
	 *         false<br>
	 */
	...
	/**
	 * Returns the team of a player, if player is not participant it returns
	 * null <br>
	 * <br>
	 *
	 * @param player
	 *            objectId as Integer<br>
	 * @return TvTEventTeam: team of the given playerObjectId, if not in event
	 *         null <br>
	 */
	...
	/**
	 * Returns the enemy team of a player, if player is not participant it
	 * returns null <br>
	 * <br>
	 *
	 * @param player
	 *            objectId as Integer<br>
	 * @return TvTEventTeam: enemy team of the given playerObjectId, if not in
	 *         event null <br>
	 */
	 ...
	 * in a team return null<br>
	 * <br>
	 *
	 * @param playerName
	 *            as String<br>
	 * @return int[]: coordinates of teams, 2 elements, index 0 for team 1 and
	 *         index 1 for team 2<br>
	 */
	...
	public static boolean isPlayerParticipant(int playerObjectId)
	{
		...
		return _teams[0].containsPlayer(playerObjectId)
	...
	public static int getParticipatedPlayersCount()
	{
		...
		return _teams[0].getParticipatedPlayerCount()
	 ...
	 * <br>
	 *
	 * @return String[]: names of teams, 2 elements, index 0 for team 1 and
	 *         index 1 for team 2<br>
	 */
	 ...
	 * <br>
	 *
	 * @return int[]: player count of teams, 2 elements, index 0 for team 1 and
	 *         index 1 for team 2<br>
	 */
	public static int[] getTeamsPlayerCounts()
	{
		return new int[] { _teams[0].getParticipatedPlayerCount(),
		        _teams[1].getParticipatedPlayerCount() };
	}
	 ...
	 *
	 * @return int[]: points of teams, 2 elements, index 0 for team 1 and index
	 *         1 for team 2<br>
	 */
