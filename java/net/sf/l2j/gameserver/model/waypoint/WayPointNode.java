 ...
 *
 * $Author: luisantonioa $ $Date: 20/07/2005 19:49:29 $ $Revision: 1 $ $Log:
 * WayPointNode.java,v $ Revision 1 20/07/2005 19:49:29 luisantonioa Added
 * copyright notice
 *
 *
...
public class WayPointNode extends L2Object
{
	...
	private static final String NORMAL = "Node", SELECTED = "Selected",
	        LINKED = "Linked";
	...
	public static WayPointNode spawn(boolean isItemId, int id,
	        L2PcInstance player)
	{
