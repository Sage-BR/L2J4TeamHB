...
public abstract class L2Transformation implements Cloneable, Runnable
{
	 ...
	 *
	 * @param id
	 *            Internal id that server will use to associate this
	 *            transformation
	 * @param graphicalId
	 ...
	 */
	public L2Transformation(int id, int graphicalId, int duration,
	        double collisionRadius, double collisionHeight)
	{
		_id = id;
	 ...
	 *
	 * @param id
	 *            Internal id(will be used also as client graphical id) that
	 *            server will use to associate this transformation
	 * @param duration
	 *            Transformation duration in seconds
	 * @param collisionRadius
	 *            Collision Radius of the player while transformed
	 ...
	 *            Collision Height of the player while transformed
	 */
	public L2Transformation(int id, int duration, double collisionRadius,
	...
	/**
	 * @return The remaining transformed time in miliseconds. An zero or
	 *         negative value if the transformation has already ended.
	 */
	public long getRemainingTime()
	{
		return (getStartTime() + this.getDuration())
