...
public class Quest extends ManagedScript
{
	...
	private static Map<String, Quest> _allEventsS = new ConcurrentHashMap<>();

	/** HashMap containing lists of timers from the name of the timer */
	private Map<String, ArrayList<QuestTimer>> _allEventTimers = new ConcurrentHashMap<>();
	...
	public static enum QuestEventType
	{
		ON_FIRST_TALK(false), // control the first dialog shown by NPCs when
		                      // they are clicked (some quests must override the
		                      // default npc action)
	 ...
	 */
	public void startQuestTimer(String name, long time, L2NpcInstance npc,
	        L2PcInstance player, boolean repeating)
	{
	...
	public QuestTimer getQuestTimer(String name, L2NpcInstance npc,
	        L2PcInstance player)
	{
	...
	public void cancelQuestTimer(String name, L2NpcInstance npc,
	        L2PcInstance player)
	{
	...
	public final boolean notifyEvent(String event, L2NpcInstance npc,
	        L2PcInstance player)
	{
		String res = null;
		try
	...
	public class tmpOnSkillSee implements Runnable
	{
		...
		public tmpOnSkillSee(L2NpcInstance npc, L2PcInstance caster,
	...
	public final boolean notifySkillSee(L2NpcInstance npc, L2PcInstance caster,
	        L2Skill skill, L2Object[] targets, boolean isPet)
	{
	...
	public final boolean notifyFactionCall(L2NpcInstance npc,
	        L2NpcInstance caller, L2PcInstance attacker, boolean isPet)
	{
		String res = null;
		try
		{
	...
	public final boolean notifyAggroRangeEnter(L2NpcInstance npc,
	        L2PcInstance player, boolean isPet)
	{
	...
	public class TmpOnAggroEnter implements Runnable
	{
		...
		public TmpOnAggroEnter(L2NpcInstance npc, L2PcInstance pc,
		        boolean isPet)
		{
			_npc = npc;
			_pc = pc;
	...
	public String onDeath(final L2Character killer, final L2Character victim,
	        final QuestState qs)
	{
	        ...
	        final L2PcInstance player)
	{
		...
		// if not overriden by a subclass, then default to the returned value of
		// the simpler (and older) onEvent override
	...
	public String onFirstTalk(final L2NpcInstance npc,
	        final L2PcInstance player)
	{
		return null;
	}
	...
	public String showHtmlFile(L2PcInstance player, String fileName)
	{
		...
		String content = HtmCache.getInstance().getHtm("data/scripts/"
		        + directory + "/" + questId + "/" + fileName);

		if (content == null)
		{
			content = HtmCache.getInstance().getHtmForce("data/scripts/quests/"
			        + questId + "/" + fileName);
		}
	...
	public L2NpcInstance addSpawn(int npcId, int x, int y, int z, int heading,
	        boolean randomOffset, int despawnDelay)
	{
	...
	/**
	 * This is used to register all monsters contained in mobs for a particular
	 * script<BR>
	 * <FONT COLOR=#FF0000><B> <U>Caution</U> : This method register ID for all
	 * QuestEventTypes<BR>
	...
	/**
	 * This is used to register all monsters contained in mobs for a particular
	 * script event types defined in types.
	 *
	 * @param mobs
	 * @param types
	 */
