...
public class QuestTimer
{
	...
	// =========================================================
	// Constructor
	public QuestTimer(Quest quest, String name, long time, L2NpcInstance npc,
	        L2PcInstance player, boolean repeating)
	{
		...
		{
			_schedular = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleTimerTask(), time); // Prepare
			                                                                                             // auto
			                                                                                             // end
			                                                                                             // task
		}
	 ...
	 *            : Name of the timer
	 * @param npc
	 *            : Npc instance attached to the desired timer (null if no npc
	 *            attached)
	 * @param player
	 *            : Player instance attached to the desired timer (null if no
	 *            player attached)
	 */
	public boolean isMatch(Quest quest, String name, L2NpcInstance npc,
	        L2PcInstance player)
	{
