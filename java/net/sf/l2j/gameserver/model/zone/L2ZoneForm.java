...
public abstract class L2ZoneForm
{
	...
	public abstract int getHighZ(); // New fishing patch makes use of that to
	                                // get the Z for the hook
	                                // landing coordinates.

	protected boolean lineSegmentsIntersect(int ax1, int ay1, int ax2, int ay2,
