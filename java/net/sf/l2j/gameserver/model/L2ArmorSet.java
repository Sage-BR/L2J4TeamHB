...
public final class L2ArmorSet
{
	...
	public L2ArmorSet(int chest, int legs, int head, int gloves, int feet,
	        int skill_id, int skill_lvl, int shield, int shield_skill_id,
	        int enchant6skill)
	{
		_chest = chest;
		_legs = legs;
	...
	public boolean containAll(int chest, int legs, int head, int gloves,
	        int feet)
	{
		...
		if ((_head != 0 && _head != head) || (_gloves != 0 && _gloves != gloves))
		{
			return false;
		}
	...
	public boolean isEnchanted6(L2PcInstance player)
	{
		...
		if ((_gloves != 0 && glovesItem.getEnchantLevel() < 6) || (_head != 0 && headItem.getEnchantLevel() < 6))
		{
			return false;
		}
