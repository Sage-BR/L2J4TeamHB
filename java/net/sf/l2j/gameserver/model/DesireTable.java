 ...
 * $Header$
 *
 * $Author$ $Date$ $Revision$ $Log$ Revision 1.1.2.1 2005/04/08 08:03:40
 * luisantonioa *** empty log message ***
 *
 * Revision 1.1 4/04/2005 17:15:07 luisantonioa Created New Class
 *
 *
...
{
	public static final DesireType[] DEFAULT_DESIRES = { DesireType.FEAR,
	        DesireType.DISLIKE, DesireType.HATE, DesireType.DAMAGE };
	...
	class Desires
	{
		...
		{
			_desireTable = new ConcurrentHashMap<>();
	...
	public DesireTable(DesireType... desireList)
	{
		...
		_objectDesireTable = new ConcurrentHashMap<>();
