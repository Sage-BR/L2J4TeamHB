...
public class L2PetDataTable
{
	...
	{
		_petTable = new ConcurrentHashMap<>();
	}
		...
		try
		{
			...
			for (int i = 0; i < petNodes.getLength(); i++)
			{
				...
				for (int j = 0; j < statNodes.getLength(); j++)
				{
					...
					{
						_petTable.put(petId, new ConcurrentHashMap<>());
					}
	...
	public void addPetData(L2PetData petData)
	{
		...
		if (h == null)
		{
			Map<Integer, L2PetData> statTable = new ConcurrentHashMap<>();
	...
	public static boolean isPetFood(int itemId)
	{
		return (itemId == 2515) || (itemId == 4038) || (itemId == 5168)
		        || (itemId == 6316) || (itemId == 7582) || (itemId == 9668)
		        || (itemId == 10425);
	}
	...
	public static boolean isPetItem(int itemId)
	{
		return (itemId == 2375 // Wolf
		        ...
		        || itemId == 8663 // Wyvern
		        || itemId == 6648 || itemId == 6649 || itemId == 6650
		        || itemId == 10311 || itemId == 10312 || itemId == 10313); // Babies
	}
