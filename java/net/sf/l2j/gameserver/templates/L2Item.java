...
public abstract class L2Item
{
	...
	private static final int[] crystalItemId = { 0, 1458, 1459, 1460, 1461,
	        1462, 1462 };

	private static final int[] crystalEnchantBonusArmor = { 0, 11, 6, 11, 19,
	        25, 25 };

	private static final int[] crystalEnchantBonusWeapon = { 0, 90, 45, 67, 144,
	        250, 250 };
	...
	{
		return this.getBodyPart() != 0
		        && !(this.getItemType() instanceof L2EtcItemType);
	}
	...
	{
		return (isConsumable() ? (int) (_referencePrice
		        * Config.RATE_CONSUMABLE_COST) : _referencePrice);
	}
