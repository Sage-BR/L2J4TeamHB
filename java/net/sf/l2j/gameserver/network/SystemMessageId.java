...
public enum SystemMessageId
{
	...
	/**
	 * ID: 231<br>
	 * Message: "After a clan member is dismissed from a clan, the clan must
	 * wait at least a day before accepting a new member."
	 */
	...
	/**
	 * ID: 1655<br>
	 * Message: "You caught something smelly and scary, maybe you should throw
	 * it back!?"
	 */
	 ...
	 * $s2 win(s) and $s3 defeat(s). You heave earned $s4 Olympiad Point(s).
	 */
	 ...
	 * match.
	 */
	YOU_ARE_ALREADY_ON_THE_WAITING_LIST_TO_PARTICIPATE_IN_THE_GAME_FOR_YOUR_CLASS(
	        1689),
	...
	/**
	 * ID: 1749<br>
	 * Message: "Congratulations! You will now graduate from the Clan Academy
	 * and leave your current clan. As a graduate of the academy, you can
	 ...
	 * be summoned.
	 */
	S1_CURRENTLY_TRADING_OR_OPERATING_PRIVATE_STORE_AND_CANNOT_BE_SUMMONED(
	        1898),
	 ...
	 * in a few moments.
	 */
	S1_HAS_ACCEPTED_YOUR_CHALLENGE_TO_A_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS(
	        1929),
	 ...
	 * in a few moments.
	 */
	YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS(
	        1930),
	 ...
	 */
	YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_PARTY_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS(
	        1933),
	 ...
	 */
	S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_ENGAGED_IN_A_PRIVATE_STORE_OR_MANUFACTURE(
	        2017),
	 ...
	 * or strider.
	 */
	S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_RIDING_A_BOAT_WYVERN_OR_STRIDER(
	        2027),
