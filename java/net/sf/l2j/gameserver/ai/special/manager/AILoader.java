...
{
	private static final Logger LOGGER = Logger.getLogger(AILoader.class.getName());
	...
	public static void init()
	{
		...
		// ThreadPoolManager.getInstance().scheduleAi(new VanHalter(-1,
		// "vanhalter", "ai"), 500);
		LOGGER.info(" - Gordon");
		...
		// ThreadPoolManager.getInstance().scheduleAi(new Transform(-1,
		// "transform", "ai"), 800);
		// LOGGER.info(" - Fairy Trees");
		// ThreadPoolManager.getInstance().scheduleAi(new FairyTrees(-1,
		// "FairyTrees", "ai"), 900);
		// LOGGER.info(" - Summon Minions");
		// ThreadPoolManager.getInstance().scheduleAi(new SummonMinions(-1,
		// "SummonMinions", "ai"), 1000);
		// LOGGER.info(" - Zombie Gatekeepers");
		// ThreadPoolManager.getInstance().scheduleAi(new ZombieGatekeepers(-1,
		// "ZombieGatekeepers", "ai"), 1100);
		// LOGGER.info(" - Ice Fairy Sirra");
		// ThreadPoolManager.getInstance().scheduleAi(new IceFairySirra(-1,
		// "IceFairySirra", "ai"), 1200);
		// LOGGER.info(" - Golkonda");
		// ThreadPoolManager.getInstance().scheduleAi(new Golkonda(-1,
		// "Golkonda", "ai"), 1300);
		// LOGGER.info(" - Hallate");
		// ThreadPoolManager.getInstance().scheduleAi(new Hallate(-1, "Hallate",
		// "ai"), 1400);
		// LOGGER.info(" - Kernon");
		// ThreadPoolManager.getInstance().scheduleAi(new Kernon(-1, "Kernon",
		// "ai"), 1500);
		// LOGGER.info(" - Varka/Ketra Ally");
		// ThreadPoolManager.getInstance().scheduleAi(new VarkaKetraAlly(-1,
		// "Varka Ketra Ally", "ai"), 1600);
		// LOGGER.info(" - Barakiel");
		// ThreadPoolManager.getInstance().scheduleAi(new Barakiel(-1,
		// "Barakiel", "ai"), 1700);
