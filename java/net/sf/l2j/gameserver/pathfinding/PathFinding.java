...
public abstract class PathFinding
{
	...
	public abstract List<AbstractNodeLoc> findPath(int x, int y, int z, int tx,
	        int ty, int tz);
	...
	public List<AbstractNodeLoc> constructPath(Node node)
	{
		...
		while (node.getParent() != null)
		{
			...
			directionx = node.getLoc().getNodeX()
			        - node.getParent().getLoc().getNodeX();
			directiony = node.getLoc().getNodeY()
			        - node.getParent().getLoc().getNodeY();
			if (directionx != previousdirectionx
