...
public abstract class ManagedScript
{
	...
	/**
	 * Attempts to reload this script and to refresh the necessary bindings with
	 * it ScriptControler.<BR>
	 * Subclasses of this class should override this method to properly refresh
	 * their bindings when necessary.
	 *
