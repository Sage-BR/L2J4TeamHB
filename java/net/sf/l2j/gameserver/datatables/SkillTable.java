...
public class SkillTable
{
	...
	private static final L2WeaponType[] weaponDbMasks = { L2WeaponType.ETC,
	        L2WeaponType.BOW, L2WeaponType.POLE, L2WeaponType.DUALFIST,
	        L2WeaponType.DUAL, L2WeaponType.BLUNT, L2WeaponType.SWORD,
	        L2WeaponType.DAGGER, L2WeaponType.BIGSWORD, L2WeaponType.ROD,
	        L2WeaponType.BIGBLUNT, L2WeaponType.ANCIENT_SWORD,
	        L2WeaponType.RAPIER, L2WeaponType.CROSSBOW };
	...
	/**
	 * Returns an array with siege skills. If addNoble == true, will add also
	 * Advanced headquarters.
	 */
	public L2Skill[] getSiegeSkills(boolean addNoble)
	{
		ArrayList<L2Skill> list = new ArrayList<>();
