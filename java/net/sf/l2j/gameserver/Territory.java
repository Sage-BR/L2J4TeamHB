 ...
 */
/*
 * coded by Balancer ported to L2JRU by Mr balancer@balancer.ru
 * http://balancer.ru
 *
 * version 0.1.1, 2005-06-07 version 0.1, 2005-03-16
 */
...
public class Territory
{
	...
	{
		_territory = new ConcurrentHashMap<>();

		Integer[][] point = SqlUtils.get2DIntArray(new String[] { "loc_id",
		        "loc_x", "loc_y", "loc_zmin", "loc_zmax",
		        "proc" }, "locations", "loc_id > 0");
