...
public final class RequestExSetPledgeCrestLarge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		        ...
		        & L2Clan.CP_CL_REGISTER_CREST) == L2Clan.CP_CL_REGISTER_CREST)
		{
			...
			{
				activeChar.sendMessage("Only a clan that owns a clan hall or a castle can get their emblem displayed on clan related items"); // there
				                                                                                                                              // is
				                                                                                                                              // a
				                                                                                                                              // system
				                                                                                                                              // message
			...
			{
				_log.log(Level.INFO, "Error loading large crest of clan:"
				        + clan.getName());
				return;
			}
