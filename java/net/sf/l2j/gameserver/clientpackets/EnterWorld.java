...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			_log.warning("HWID not validated for: "
		...
		if (SiegeRewardManager.ACTIVATED_SYSTEM
		        && !SiegeRewardManager.REWARD_ACTIVE_MEMBERS_ONLY)
		{
		...
		if (!activeChar.isGM() && activeChar.getSiegeState() < 2
