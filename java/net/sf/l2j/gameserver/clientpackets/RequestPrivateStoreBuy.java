...
//	private static final String _C__79_SENDPRIVATESTOREBUYLIST = "[C] 79 SendPrivateStoreBuyList";
	...
	protected void readImpl()
	{
		...
		if (_count < 0 || _count * 12 > _buf.remaining()
	...
	protected void runImpl()
	{
		...
		if (!(object instanceof L2PcInstance) || player.isCursedWeaponEquipped())
		{
			return;
		}
		...
		// FIXME: this check should be (and most probably is) done in the
		// TradeList mechanics
		long priceTotal = 0;
		...
		{
			sendPacket(ActionFailed.STATIC_PACKET);
			_log.warning("PrivateStore buy has failed due to invalid list or request. Player: "
