...
public final class RequestExAskJoinMPCC extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		// invite yourself? ;)
		if ((player == null) || (activeChar.isInParty() && player.isInParty()
		...
		if (activeChar.isInParty())
		{
			...
			// activeChar is PartyLeader? && activeChars Party is already in a
			// CommandChannel?
