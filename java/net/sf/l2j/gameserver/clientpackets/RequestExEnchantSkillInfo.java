...
public final class RequestExEnchantSkillInfo extends L2GameClientPacket
{
	...
	public void showEnchantInfo(L2PcInstance activeChar, boolean isSafeEnchant)
	{
		...
		if (enchantLearn != null)
		{
			...
			if (_skillLvl > 100)
			{
				...
				EnchantSkillDetail esd = enchantLearn.getEnchantSkillDetail(_skillLvl
				        + 1);
	...
	public void showChangeEnchantInfo(L2PcInstance activeChar)
	{
		...
		if (enchantLearn != null)
		{
			...
			{
				_log.warning("Client: " + this.getClient()
				        + " requested change route information for unenchanted skill");
			}
		}
	}
	...
	public void showUntrainEnchantInfo(L2PcInstance activeChar)
	{
		...
		if (enchantLearn != null)
		{
			...
			if (_skillLvl > 100)
			{
				...
				{
					_log.warning("Client: " + this.getClient()
					        + " tried to untrain enchanted skill, but server doesnt has data for his current skill enchantment level");
				}
			...
			{
				_log.warning("Client: " + this.getClient()
				        + " requested untrain information for unenchanted skill");
			}
		}
	}
