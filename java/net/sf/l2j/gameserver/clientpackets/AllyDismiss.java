...
public final class AllyDismiss extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		leaderClan.setAllyPenaltyExpiryTime(currentTime
		        + Config.ALT_ACCEPT_CLAN_DAYS_WHEN_DISMISSED
		                * 86400000L, L2Clan.PENALTY_TYPE_DISMISS_CLAN); // 24*60*60*1000
		                                                                // =
		                                                                // 86400000
		...
		clan.setAllyPenaltyExpiryTime(currentTime
		        + Config.ALT_ALLY_JOIN_DAYS_WHEN_DISMISSED
		                * 86400000L, L2Clan.PENALTY_TYPE_CLAN_DISMISSED); // 24*60*60*1000
		                                                                  // =
		                                                                  // 86400000
		clan.updateClanInDB();
