...
//		 count*20 is the size of a for iteration of each item
		if (_count < 0 || _count * 20 > _buf.remaining()
	...
	protected void runImpl()
	{
		...
		if ((storePlayer.getPrivateStoreType() != L2PcInstance.STORE_PRIVATE_BUY) || player.isCursedWeaponEquipped())
		{
			return;
		}
		...
		{
			sendPacket(ActionFailed.STATIC_PACKET);
			_log.warning("PrivateStore sell has failed due to invalid list or request. Player: "
