...
public class LilimKnightNormal extends L2Transformation
{
	...
	{
		// Attack Buster
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(568, 3), false);
		// Attack Storm
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(569, 3), false);
		// Attack Rage
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(570, 3), false);
		// Poison Dust
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(571, 3), false);
		// Transfrom Dispel
	...
	{
		// Attack Buster
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(568, 3), false);
		// Attack Storm
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(569, 3), false);
		// Attack Rage
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(570, 3), false);
		// Poison Dust
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(571, 3), false);
		// Transfrom Dispel
