...
public class DragonBomberStrong extends L2Transformation
{
	...
	{
		// Death Blow
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(580, 4), false);
		// Sand Cloud
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(581, 4), false);
		// Scope Bleed
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(582, 4), false);
		// Assimilation
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(583, 4), false);
		// Transfrom Dispel
	...
	{
		// Death Blow
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(580, 4), false);
		// Sand Cloud
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(581, 4), false);
		// Scope Bleed
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(582, 4), false);
		// Assimilation
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(583, 4), false);
		// Transfrom Dispel
