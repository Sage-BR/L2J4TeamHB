...
public class DragonBomberNormal extends L2Transformation
{
	...
	{
		// Death Blow
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(580, 3), false);
		// Sand Cloud
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(581, 3), false);
		// Scope Bleed
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(582, 3), false);
		// Assimilation
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(583, 3), false);
		// Transfrom Dispel
	...
	{
		// Death Blow
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(580, 3), false);
		// Sand Cloud
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(581, 3), false);
		// Scope Bleed
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(582, 3), false);
		// Assimilation
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(583, 3), false);
		// Transfrom Dispel
