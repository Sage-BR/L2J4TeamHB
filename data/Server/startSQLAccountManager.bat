...
color 17
java -Djava.util.logging.config.file="%~dp0console.cfg" -cp "%~dp0lib\*;%~dp0l2jserver.jar" net.sf.l2j.accountmanager.SQLAccountManager 2> NUL
if %errorlevel% == 0 (
echo.
...
echo.
echo - Missing .jar files or lib directory.
